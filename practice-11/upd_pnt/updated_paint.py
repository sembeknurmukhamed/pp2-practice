...
def draw_toolbar():
   ...
   for i, t in enumerate(tools):
      ...
      txt = font.render(nice_names[t], True, WHITE)
...
def draw_square(surface, color, start, end):
   # квадрат = берём минимальную сторону
      ...
      if event.type == pygame.MOUSEBUTTONUP:
         if drawing:
               ...
               if tool == "rectangle":
                  ...
                  draw_square(canvas, current_color, start_pos, (x, y))

               elif tool == "right_triangle":
                  draw_right_triangle(canvas, current_color, start_pos, (x, y))

               elif tool == "equilateral_triangle":
                  draw_equilateral_triangle(canvas, current_color, start_pos, (x, y))

               elif tool == "rhombus":
                  draw_rhombus(canvas, current_color, start_pos, (x, y))
      ...
      if event.type == pygame.MOUSEMOTION and drawing:
         ...
         if tool == "brush":
            ...
            if tool == "rectangle":
               ...
               draw_square(preview_surface, current_color, start_pos, (x, y))

            elif tool == "right_triangle":
               draw_right_triangle(preview_surface, current_color, start_pos, (x, y))

            elif tool == "equilateral_triangle":
               draw_equilateral_triangle(preview_surface, current_color, start_pos, (x, y))

            elif tool == "rhombus":
               draw_rhombus(preview_surface, current_color, start_pos, (x, y))
